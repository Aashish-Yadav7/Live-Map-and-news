 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pS=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),Br=(t,e)=>{const n=st.forwardRef(({color:i="currentColor",size:r=24,strokeWidth:s=2,absoluteStrokeWidth:a,className:o="",children:l,...u},d)=>st.createElement("svg",{ref:d,...hS,width:r,height:r,stroke:i,strokeWidth:a?Number(s)*24/Number(r):s,className:["lucide",`lucide-${pS(t)}`,o].join(" "),...u},[...e.map(([h,c])=>st.createElement(h,c)),...Array.isArray(l)?l:[l]]));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`;function tA({newsItems:t,onNewsHover:e,onNewsClick:n}){const i=st.useRef(null),r=st.useRef(e),s=st.useRef(n),a=st.useRef([]),o=st.useRef(null);return st.useEffect(()=>{r.current=e},[e]),st.useEffect(()=>{s.current=n},[n]),st.useEffect(()=>{const l=o.current;if(!l||(l.clear(),a.current=[],t.length===0))return;const u=new vs(.012,8,8);t.forEach(d=>{const h=d.category==="accident",c=new th({color:h?15680580:3900150,depthTest:!0,depthWrite:!0,toneMapped:!1}),p=new Sn(u,c),x=new _s;x.position.copy(Qw(d.lat,d.lng,1)),x.add(p),l.add(x),a.current.push({group:x,dot:p,item:d})})},[t]),st.useEffect(()=>{const l=i.current;if(!l)return;const u=new Ry;u.background=new Ze(0);const d=l.clientWidth||800,h=l.clientHeight||600,c=new bn(42,d/h,.1,100);c.position.set(0,0,2.8);const p=new jw({antialias:!0});p.setPixelRatio(Math.min(window.devicePixelRatio,2)),p.setSize(d,h),p.outputColorSpace=on,l.appendChild(p.domElement),u.add(new Qy(14544639,.7));const x=new jy(16775408,.9);x.position.set(5,3,4),u.add(x);const E=new vs(1,128,128),m=new rm({color:1723776,roughness:.78,metalness:0}),f=new Sn(E,m);f.rotation.x=Hp.degToRad(-8),u.add(f);const _=new $y;_.crossOrigin="anonymous";let S=!1;const y=ne=>{const Ie=["https://unpkg.com/three-globe@2.31.1/example/img/earth-blue-marble.jpg","https://cdn.jsdelivr.net/npm/three-globe@2.31.1/example/img/earth-blue-marble.jpg"];ne>=Ie.length||_.load(Ie[ne],ke=>{S||(S=!0,ke.colorSpace=on,ke.anisotropy=p.capabilities.getMaxAnisotropy(),m.map=ke,m.color.set(16777215),m.needsUpdate=!0)},void 0,()=>y(ne+1))};y(0),_.load("https://unpkg.com/three-globe@2.31.1/example/img/earth-topology.png",ne=>{m.bumpMap=ne,m.bumpScale=.01,m.needsUpdate=!0}),_.load("https://unpkg.com/three-globe@2.31.1/example/img/earth-water.png",ne=>{m.roughnessMap=ne,m.needsUpdate=!0});const w=new rm({transparent:!0,opacity:0,roughness:1,metalness:0,depthWrite:!1}),T=new Sn(new vs(1.005,64,64),w);f.add(T),_.load("https://unpkg.com/three-globe@2.31.1/example/img/earth-clouds.png",ne=>{w.alphaMap=ne,w.color.set(16777215),w.opacity=.85,w.needsUpdate=!0});const C=new qn({vertexShader:Jw,fragmentShader:eA,side:Pi,transparent:!0,depthWrite:!1,blending:tf});u.add(new Sn(new vs(1.1,64,64),C));const v=new _s;f.add(v),o.current=v;let A=!0,b=Hp.degToRad(-20);f.rotation.y=b;const P=new B;let F=0;const $=()=>{F=requestAnimationFrame($),A&&(b+=.0022,f.rotation.y=b),a.current.forEach(({group:ne})=>{ne.getWorldPosition(P),ne.visible=P.z>.04}),p.render(u,c)};$();const J=new tM,O=new $e;let K=null;const z=(ne,Ie)=>{var pt;const ke=p.domElement.getBoundingClientRect();O.x=(ne-ke.left)/ke.width*2-1,O.y=-((Ie-ke.top)/ke.height)*2+1,J.setFromCamera(O,c);const dt=a.current.filter(lt=>lt.group.visible).map(lt=>lt.dot),ht=J.intersectObjects(dt);return ht.length?((pt=a.current.find(lt=>lt.dot===ht[0].object))==null?void 0:pt.item)??null:null};let I=!1,W=!1,Z={x:0,y:0},te=0;const oe=ne=>{I=!0,W=!1,A=!1,clearTimeout(te),Z={x:ne.clientX,y:ne.clientY},p.domElement.style.cursor="grabbing"},Ve=ne=>{var ke;if(I){const dt=ne.clientX-Z.x,ht=ne.clientY-Z.y;Math.hypot(dt,ht)>2&&(W=!0),b+=dt*.006,f.rotation.y=b,f.rotation.x=Math.max(-1.2,Math.min(1.2,f.rotation.x+ht*.006)),Z={x:ne.clientX,y:ne.clientY};return}const Ie=z(ne.clientX,ne.clientY);Ie!==K&&(K=Ie,(ke=r.current)==null||ke.call(r,Ie,ne.clientX,ne.clientY),a.current.forEach(({dot:dt,item:ht})=>dt.scale.setScalar(ht.url===(Ie==null?void 0:Ie.url)?2.2:1))),p.domElement.style.cursor=Ie?"pointer":"grab"},je=()=>{I=!1,p.domElement.style.cursor=K?"pointer":"grab",te=window.setTimeout(()=>{A=!0},3e3)},We=ne=>{var ke;if(W)return;const Ie=z(ne.clientX,ne.clientY);Ie&&((ke=s.current)==null||ke.call(s,Ie))},q=ne=>{ne.preventDefault(),c.position.z=Math.max(1.5,Math.min(6.5,c.position.z+ne.deltaY*.004))};let ae={x:0,y:0},re=!1,Le=0,Ue=0;const be=ne=>{ne.preventDefault(),A=!1,clearTimeout(te),ne.touches.length===1?(re=!1,ae={x:ne.touches[0].clientX,y:ne.touches[0].clientY}):ne.touches.length===2&&(Le=Math.hypot(ne.touches[0].clientX-ne.touches[1].clientX,ne.touches[0].clientY-ne.touches[1].clientY),Ue=c.position.z)},_t=ne=>{if(ne.preventDefault(),ne.touches.length===1){const Ie=ne.touches[0].clientX-ae.x,ke=ne.touches[0].clientY-ae.y;Math.hypot(Ie,ke)>4&&(re=!0),b+=Ie*.006,f.rotation.y=b,f.rotation.x=Math.max(-1.2,Math.min(1.2,f.rotation.x+ke*.006)),ae={x:ne.touches[0].clientX,y:ne.touches[0].clientY}}else if(ne.touches.length===2){const Ie=Math.hypot(ne.touches[0].clientX-ne.touches[1].clientX,ne.touches[0].clientY-ne.touches[1].clientY);c.position.z=Math.max(1.5,Math.min(6.5,Ue*(Le/Ie)))}},He=ne=>{var Ie;if(ne.preventDefault(),!re&&ne.changedTouches.length===1){const ke=z(ne.changedTouches[0].clientX,ne.changedTouches[0].clientY);ke&&((Ie=s.current)==null||Ie.call(s,ke))}ne.touches.length===0&&(te=window.setTimeout(()=>{A=!0},3e3))},et=new ResizeObserver(()=>{const ne=l.clientWidth,Ie=l.clientHeight;c.aspect=ne/Ie,c.updateProjectionMatrix(),p.setSize(ne,Ie)});et.observe(l);const De=p.domElement;return De.style.cursor="grab",De.addEventListener("mousedown",oe),De.addEventListener("mousemove",Ve),window.addEventListener("mouseup",je),De.addEventListener("click",We),De.addEventListener("wheel",q,{passive:!1}),De.addEventListener("touchstart",be,{passive:!1}),De.addEventListener("touchmove",_t,{passive:!1}),De.addEventListener("touchend",He,{passive:!1}),()=>{cancelAnimationFrame(F),clearTimeout(te),et.disconnect(),De.removeEventListener("mousedown",oe),De.removeEventListener("mousemove",Ve),window.removeEventListener("mouseup",je),De.removeEventListener("click",We),De.removeEventListener("wheel",q),De.removeEventListener("touchstart",be),De.removeEventListener("touchmove",_t),De.removeEventListener("touchend",He),p.dispose(),l.contains(De)&&l.removeChild(De),o.current=null}},[]),ie.jsxs("div",{className:"relative w-full h-full bg-black",children:[ie.jsx("div",{ref:i,className:"w-full h-full touch-none"}),ie.jsxs("div",{className:"absolute bottom-3 left-1/2 -translate-x-1/2 text-xs text-white/40 px-3 py-1 rounded-full bg-black/30 backdrop-blur-sm pointer-events-none whitespace-nowrap",children:[ie.jsx("span",{className:"hidden sm:inline",children:"Drag to rotate · Scroll to zoom · Click a dot"}),ie.jsx("span",{className:"sm:hidden",children:"Drag · Pinch to zoom · Tap dot"})]})]})}const Vo="https://ehieqmpmkyouoyjebuqa.supabase.co/functions/v1/news",Om="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVoaWVxbXBta3lvdW95amVidXFhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQ4MDg5NTksImV4cCI6MjEwMDM4NDk1OX0.w3X-40as6pVsq9-wI3xoMjx0RKmE_jsmEQ6575gdJSU";function Bm(t){return!(!t.url||!t.url.startsWith("http")||t.url.includes("google.com/search"))}function nA(t=""){const[e,n]=st.useState([]),[i,r]=st.useState(!0),[s,a]=st.useState(null),o=st.useCallback(async l=>{try{r(!0);const u=l?`${Vo}?country=${encodeURIComponent(l)}`:Vo,d=await fetch(u,{headers:{Authorization:`Bearer ${Om}`}});if(!d.ok)throw new Error(`Failed (${d.status})`);const h=await d.json();if(h.error){a(h.error),n([]);return}const p=(h.items||[]).filter(Bm);n(p),a(null)}catch(u){a(u instanceof Error?u.message:"Failed to load news")}finally{r(!1)}},[]);return st.useEffect(()=>{let l=!1;const u=async()=>{try{r(!0);const h=t?`${Vo}?country=${encodeURIComponent(t)}`:Vo,c=await fetch(h,{headers:{Authorization:`Bearer ${Om}`}});if(!c.ok)throw new Error(`Failed (${c.status})`);const p=await c.json();if(l)return;if(p.error){a(p.error),n([]);return}const E=(p.items||[]).filter(Bm);n(E),a(null)}catch(h){if(l)return;a(h instanceof Error?h.message:"Failed to load news")}finally{l||r(!1)}};u();const d=setInterval(u,5*60*1e3);return()=>{l=!0,clearInterval(d)}},[t]),{items:e,loading:i,error:s,refetch:o}}function iA(){const[t,e]=st.useState(""),[n,i]=st.useState(""),{items:r,loading:s,error:a}=nA(n),[o,l]=st.useState(null),[u,d]=st.useState({x:0,y:0}),[h,c]=st.useState(null),p=st.useCallback((S,y,w)=>{l(S),d({x:y,y:w})},[]),x=st.useCallback(S=>{S.preventDefault(),i(t.trim()),c(null)},[t]),E=st.useCallback(()=>{e(""),i(""),c(null)},[]),m=r.filter(S=>S.category==="accident").length,f=r.filter(S=>S.category==="research").length,_=S=>{window.open(`https://www.google.com/search?q=${encodeURIComponent(S.title)}`,"_blank","noopener,noreferrer")};return ie.jsxs("div",{className:"h-screen w-screen bg-gradient-to-b from-neutral-950 via-black to-neutral-950 text-white flex flex-col overflow-hidden",children:[ie.jsxs("header",{className:"border-b border-neutral-800/60 px-4 sm:px-6 py-3 flex items-center justify-between gap-3 flex-shrink-0",children:[ie.jsx("div",{className:"flex items-center gap-2",children:ie.jsx("img",{src:"/images/world_logo copy copy.png",alt:"World News Globe",className:"h-10 sm:h-12 w-auto object-contain drop-shadow-[0_0_8px_rgba(59,130,246,0.4)]"})}),ie.jsxs("div",{className:"flex items-center gap-3 sm:gap-4",children:[ie.jsxs("div",{className:"flex items-center gap-3 sm:gap-4 text-sm",children:[ie.jsxs("div",{className:"flex items-center gap-2",children:[ie.jsx("span",{className:"w-3 h-3 rounded-full bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.6)]"}),ie.jsx("span",{className:"text-neutral-300 hidden sm:inline",children:"Accidents & Events"}),ie.jsxs("span",{className:"text-neutral-500 text-xs",children:["(",m,")"]})]}),ie.jsxs("div",{className:"flex items-center gap-2",children:[ie.jsx("span",{className:"w-3 h-3 rounded-full bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.6)]"}),ie.jsx("span",{className:"text-neutral-300 hidden sm:inline",children:"Research & Tech"}),ie.jsxs("span",{className:"text-neutral-500 text-xs",children:["(",f,")"]})]})]}),s&&ie.jsxs("div",{className:"flex items-center gap-2 text-xs text-neutral-400",children:[ie.jsx(mS,{className:"w-4 h-4 animate-spin"}),ie.jsx("span",{className:"hidden sm:inline",children:"Fetching news..."})]})]})]}),ie.jsxs("div",{className:"px-4 pt-3 pb-3 border-b border-neutral-800/60",children:[ie.jsxs("form",{onSubmit:x,className:"flex items-center gap-2",children:[ie.jsxs("div",{className:"relative flex-1",children:[ie.jsx(bp,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-500"}),ie.jsx("input",{type:"text",value:t,onChange:S=>e(S.target.value),placeholder:"Search by country (e.g. Japan, Brazil, France)...",className:"w-full pl-9 pr-3 py-2 bg-neutral-900 border border-neutral-700 rounded-lg text-sm text-neutral-200 placeholder-neutral-500 focus:outline-none focus:border-blue-500 transition-colors"})]}),ie.jsxs("button",{type:"submit",className:"px-3 py-2 bg-blue-600 hover:bg-blue-500 active:bg-blue-700 transition-colors rounded-lg text-sm font-medium text-white flex items-center gap-1.5 flex-shrink-0",children:[ie.jsx(Lp,{className:"w-4 h-4"}),ie.jsx("span",{className:"hidden sm:inline",children:"Filter"})]}),n&&ie.jsx("button",{type:"button",onClick:E,className:"px-2.5 py-2 bg-neutral-800 hover:bg-neutral-700 transition-colors rounded-lg text-sm text-neutral-300 flex items-center gap-1 flex-shrink-0",title:"Clear filter",children:ie.jsx(Dp,{className:"w-4 h-4"})})]}),n&&ie.jsxs("div",{className:"mt-2 flex items-center gap-1.5 text-xs text-blue-300",children:[ie.jsx(bp,{className:"w-3.5 h-3.5"}),ie.jsxs("span",{children:["Showing news for: ",ie.jsx("span",{className:"font-medium capitalize",children:n})]})]})]}),ie.jsxs("main",{className:"flex-1 flex flex-col sm:flex-row relative overflow-hidden min-h-0",children:[ie.jsxs("div",{className:`relative overflow-hidden flex-shrink-0
                        h-[52vh] sm:h-full sm:flex-1`,children:[ie.jsx(tA,{newsItems:r,onNewsHover:p,onNewsClick:c}),o&&!h&&ie.jsxs("div",{className:"fixed z-50 pointer-events-none max-w-xs bg-neutral-900/95 backdrop-blur-md border border-neutral-700 rounded-xl p-3 shadow-2xl animate-fade-in",style:{left:Math.min(u.x+14,window.innerWidth-320),top:u.y+14},children:[ie.jsxs("div",{className:"flex items-start gap-2",children:[o.category==="accident"?ie.jsx(vo,{className:"w-4 h-4 text-red-400 mt-0.5 flex-shrink-0"}):ie.jsx(Pp,{className:"w-4 h-4 text-blue-400 mt-0.5 flex-shrink-0"}),ie.jsxs("div",{children:[ie.jsx("p",{className:"text-xs text-neutral-400 mb-1",children:o.category==="accident"?"Accident / Event":"Research / Tech"}),ie.jsx("p",{className:"text-sm text-white leading-snug line-clamp-3",children:o.title}),ie.jsx("p",{className:"text-xs text-neutral-500 mt-1",children:o.source})]})]}),ie.jsx("p",{className:"text-xs text-blue-400 mt-2",children:"Tap to open article"})]}),a&&a.includes("GNEWS_API_KEY")&&ie.jsxs("div",{className:"absolute top-4 left-1/2 -translate-x-1/2 bg-amber-950/80 border border-amber-700 rounded-lg px-4 py-3 text-sm text-amber-200 flex items-center gap-2 max-w-md",children:[ie.jsx(vo,{className:"w-4 h-4 flex-shrink-0"}),ie.jsx("span",{children:"News API key not set. Add GNEWS_API_KEY in Supabase secrets to load real news."})]}),a&&!a.includes("GNEWS_API_KEY")&&ie.jsxs("div",{className:"absolute top-4 right-4 bg-red-950/80 border border-red-800 rounded-lg px-4 py-2 text-sm text-red-300 flex items-center gap-2",children:[ie.jsx(vo,{className:"w-4 h-4"}),ie.jsxs("span",{children:["Failed to load news: ",a]})]})]}),ie.jsxs("aside",{className:`flex flex-col flex-shrink-0 overflow-hidden
                          flex-1 sm:flex-none sm:w-80
                          border-t sm:border-t-0 sm:border-l border-neutral-800/60
                          bg-neutral-950/80 min-h-0`,children:[ie.jsxs("div",{className:"px-4 py-3 border-b border-neutral-800/60 flex items-center justify-between flex-shrink-0",children:[ie.jsx("h2",{className:"text-sm font-semibold text-neutral-200",children:"Latest Reports"}),ie.jsxs("span",{className:"text-xs text-neutral-500",children:[r.length," items"]})]}),ie.jsxs("div",{className:"flex-1 overflow-y-auto overscroll-contain min-h-0",children:[r.length===0&&!s&&ie.jsx("div",{className:"p-4 text-sm text-neutral-500 text-center",children:a?"Could not load news data.":"No news items found."}),r.map((S,y)=>ie.jsxs("button",{className:`w-full text-left px-4 py-3 border-b border-neutral-800/40 hover:bg-neutral-800/40 active:bg-neutral-800/60 transition-colors flex items-start gap-3 ${(h==null?void 0:h.url)===S.url?"bg-neutral-800/50":""}`,onClick:()=>c(S),children:[ie.jsx("div",{className:"mt-1 flex-shrink-0",children:S.category==="accident"?ie.jsx("span",{className:"block w-2.5 h-2.5 rounded-full bg-red-500 shadow-[0_0_6px_rgba(239,68,68,0.5)]"}):ie.jsx("span",{className:"block w-2.5 h-2.5 rounded-full bg-blue-500 shadow-[0_0_6px_rgba(59,130,246,0.5)]"})}),ie.jsxs("div",{className:"min-w-0 flex-1",children:[ie.jsx("p",{className:"text-sm text-neutral-200 leading-snug line-clamp-2",children:S.title}),ie.jsxs("p",{className:"text-xs text-neutral-500 mt-0.5 flex items-center gap-1",children:[S.source,ie.jsx(Cp,{className:"w-3 h-3 inline-block flex-shrink-0 text-neutral-600"})]})]})]},y))]})]})]}),h&&ie.jsxs("div",{className:"fixed inset-0 z-40 flex justify-end",onClick:()=>c(null),children:[ie.jsx("div",{className:"absolute inset-0 bg-black/50 backdrop-blur-sm"}),ie.jsxs("div",{className:"relative w-full max-w-md bg-neutral-950 border-l border-neutral-800 h-full overflow-y-auto animate-slide-in",onClick:S=>S.stopPropagation(),children:[ie.jsxs("div",{className:"sticky top-0 bg-neutral-950/95 backdrop-blur-md border-b border-neutral-800 px-5 py-4 flex items-center justify-between z-10",children:[ie.jsxs("div",{className:"flex items-center gap-2",children:[h.category==="accident"?ie.jsx(vo,{className:"w-5 h-5 text-red-400"}):ie.jsx(Pp,{className:"w-5 h-5 text-blue-400"}),ie.jsx("span",{className:"text-sm font-medium text-neutral-300",children:h.category==="accident"?"Accident / Event":"Research / Tech"})]}),ie.jsx("button",{onClick:()=>c(null),className:"text-neutral-400 hover:text-white transition-colors p-1 rounded-lg hover:bg-neutral-800",children:ie.jsx(Dp,{className:"w-5 h-5"})})]}),ie.jsxs("div",{className:"p-5 space-y-4",children:[ie.jsx("h2",{className:"text-lg font-semibold leading-tight",children:h.title}),ie.jsxs("div",{className:"flex items-center gap-3 text-xs text-neutral-400",children:[ie.jsx("span",{className:"px-2 py-1 rounded-md bg-neutral-800 text-neutral-300",children:h.source}),ie.jsx("span",{children:new Date(h.publishedAt).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})})]}),ie.jsxs("div",{className:"text-sm text-neutral-300",children:[ie.jsx("p",{className:"text-neutral-500 mb-1",children:"Location"}),ie.jsxs("p",{children:[h.lat.toFixed(2),", ",h.lng.toFixed(2)]})]}),h.summary&&ie.jsxs("div",{className:"text-sm text-neutral-300",children:[ie.jsx("p",{className:"text-neutral-500 mb-1",children:"Summary"}),ie.jsx("p",{className:"leading-relaxed",children:h.summary})]}),ie.jsxs("div",{className:"space-y-2 pt-2",children:[ie.jsxs("a",{href:h.url,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-blue-600 hover:bg-blue-500 active:bg-blue-700 transition-colors rounded-lg text-sm font-medium text-white",children:["Read full article",ie.jsx(Cp,{className:"w-4 h-4"})]}),ie.jsxs("button",{onClick:()=>_(h),className:"inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 border border-neutral-700 hover:border-neutral-500 transition-colors rounded-lg text-sm text-neutral-300 hover:text-white",children:[ie.jsx(Lp,{className:"w-4 h-4"}),"Search on Google"]})]})]})]})]})]})}lc.createRoot(document.getElementById("root")).render(ie.jsx(tv.StrictMode,{children:ie.jsx(iA,{})}));
