...
export default function App() {
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-neutral-950 via-black to-neutral-950 text-white flex flex-col overflow-hidden">
      {/* Header */}
      ...
      {/* Main content - globe fixed, news scrollable */}
      <main className="flex-1 flex relative overflow-hidden">
        {/* Globe - fixed position, does not scroll */}
        <div className="flex-1 flex items-center justify-center p-2 sm:p-4 relative h-full overflow-hidden">
          <Globe
            width={900}
            height={700}
            newsItems={items}
          ...
          {hovered && !selected && (
            ...
            >
              ...
              <p className="text-xs text-blue-400 mt-2">Click to read more</p>
            </div>
          )}
          {error && (
        ...
        {/* News panel - scrollable on the right only */}
        <aside className="w-72 sm:w-80 border-l border-neutral-800/60 bg-neutral-950/50 flex flex-col h-full flex-shrink-0">
          ...
          >
            ...
            <div className="p-5 space-y-4">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-500 transition-colors rounded-lg text-sm font-medium text-white"
              >
                Read full article
